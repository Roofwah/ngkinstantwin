...
import FordInstantWinEnter from './pages/FordInstantWinEnter';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/enter/ford"           element={<FordInstantWinEnter />} />
        <Route path="/enter/hoka"           element={<Navigate to="/enter?campaign=hoka-2026" replace />} />
